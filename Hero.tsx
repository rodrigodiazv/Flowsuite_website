...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-grid">
      {/* Ambient blobs */}
      <div className="blob blob-teal absolute top-[-100px] left-[-100px] opacity-15" />
      <div className="blob blob-purple absolute bottom-[-50px] right-[-100px] opacity-12" />
      <div className="blob blob-teal absolute bottom-[20%] left-[60%] w-[300px] h-[300px] opacity-08" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        {/* Headline */}
        <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-800 leading-[1.0] tracking-tight mb-6">
          <span className="text-white">Tu negocio,</span>
          <br />
          <span className="gradient-text">siempre activo.</span>
          <br />
          <span className="text-white/70 text-4xl md:text-5xl lg:text-6xl font-600">Con inteligencia.</span>
        </h1>

        <p className="font-body text-lg md:text-xl text-white/55 max-w-2xl mx-auto mb-10 leading-relaxed">
          Empleados digitales que <span className="text-neon font-500">atienden, convierten y fidelizan</span> a tus clientes.
          Voz, texto y automatización inteligente para PYMEs en España y Suiza.
        </p>

        {/* CTAs */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <a href="#demo" className="btn-neon btn-primary text-base px-8 py-4 rounded-xl font-700 font-display">
            Hablar con FLOWY
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M13 7l5 5m0 0l-5 5m5-5H6" />
            </svg>
          </a>
          <a href="#como-funciona" className="btn-neon text-base px-8 py-4 rounded-xl font-600">
            Ver cómo funciona
          </a>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3">
          {[
            ...
            <div key={i} className="flex items-center gap-2">
              <span className="font-display text-neon font-700 text-lg neon-glow">{s.n}</span>
