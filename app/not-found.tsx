  ...
  return (
    <main className="min-h-screen bg-bg flex flex-col items-center justify-center px-6 text-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-lg">
        ...
        <h1 className="font-display text-8xl md:text-9xl font-extrabold leading-none mb-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/" className="btn-neon btn-primary text-sm px-7 py-3 rounded-xl font-display font-bold">
            Volver al inicio
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M13 7l5 5m0 0l-5 5m5-5H6" />
            </svg>
          </Link>
          <a href="mailto:info@flowsuite.ch" className="btn-neon text-sm px-7 py-3 rounded-xl font-semibold">
            Contactar
          </a>
        </div>
      </div>
